...
+
Cloud Native applications can be composed of microservices and each microservice handling multiple endpoints. Intrumenting the code of these microservices enable us to obverse their behavior and quicly narrow down to a specific service; and whithin that service, to further narrow down to a specific endpoint having problems. 
