...
. The handler has a sleep step in the method `sayHello` that delays the response every 3rd request. Open the file `ssrc/main/java/com/example/servicea/HelloController.java` and locate the culprit code.
+
[source, java]
----
